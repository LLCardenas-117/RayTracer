...
//    glm::vec3 normal = // transform up vector
...
//    raycastHit.material = // material pointer (get())
//
//    return true;
//}
//
...
//    t = //(planePoint - rayOrigin) · planeNormal / denominator;
//
//
//    // return true if within distance bounds
//    return // t is witnin > min distance and < max distance
//}
